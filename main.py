...
class UI(QMainWindow):
    ...
    def __init__(self, app):
        ...
        self.printTerminal("Welcome to the Penguins ROV control interface.")
    ...
    def setLogo(self, theme):
        ...
        if theme:
            ...
            avalonPixmap = QPixmap('/graphics/Penguin with bg.jpg')
...
class TOOLBAR():
    ...
    def openGitHub(self):
        ...
        Opens the Penguins ROV GitHub page.
        ...
        """
        try:
            open('https://github.com/MATE-ROV-Penguins')
        except:
            self.ui.printTerminal("Error: GitHub Organization could not be opened.")
...
def guiInitiate(): 
    ...
    splash_pix = QPixmap('graphics/splash_screen.png').scaled(800, 600, Qt.KeepAspectRatio, Qt.SmoothTransformation)
    ...
    app.setStyle("Fusion")
    app.setWindowIcon(QIcon('graphics/Penguin.png'))
    
    # INITIATE MAIN GUI OBJECT
    program = UI(app)
    program.setWindowTitle("Penguins ROV Control Interface")
